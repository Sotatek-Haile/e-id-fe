            ...
            <div className="w-[48%] ]">
              ...
              >
                <div className="flex justify-between">
                  <b>Căn Cước Công Dân:</b> <p> 18203989138217390701</p>
                </div>
                <div className="flex justify-between">
                  <b>Tên:</b> <p> Đậu Thị Khánh Huyền</p>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <b>Nơi thường trú::</b> <p> Sô nhà 11, ngõ 22, Xuân Thuỷ, Bắc Từ Liêm, Hà Nội</p>
                </div>
                <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <div className="w-[48%]">
                  <Card
                    ...
                    style={{ width: "100%", height: 350 }}
                  >
                    <QRCode value="https://ant.design/" color={"yellow"} bgColor={"red"} />
                  </Card>
                </div>
                <div className=" w-[48%]">
                    ...
                    items={[
                      {
                        children: (
                          <div className="flex">
                            <b className="text-yellow-600 pr-5">01/01/1990: </b>
                            <p>Khai sinh.</p>............... &nbsp;&nbsp;
                            <Avatar
                              style={{
                                paddingLeft: "20px",
                      ...
                      },
                      {
                        ...
                        children: (
                          <div className="flex">
                            <b className="text-yellow-600 pr-5">01/01/1990: </b>
                            <p>Trượt tốt nghiệp đại học quốc gia.</p>............... &nbsp;&nbsp;
                            <Avatar
                              style={{ paddingLeft: "20px", backgroundColor: "red", color: "#fff" }}
                            >
                              -10
                            </Avatar>
                          </div>
